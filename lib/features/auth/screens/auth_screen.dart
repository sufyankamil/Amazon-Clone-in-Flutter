...
class _AuthScreenState extends State<AuthScreen> {
  ...
  var adminE = dotenv.env['admin_email'];

  var adminP = dotenv.env['admin_pass'];
  ...
  void signInUser() {
    authService.signInUser(
      ...
      email: emailController.text,
      password: passwordController.text,
      type: emailController.text == adminE && passwordController.text == adminP
          ? 'admin'
          : 'user',
    );
  }
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomButton(
                              text: 'Sign in', onTap: _submitFormSignIn),
                          const SizedBox(height: 20),
                        ],
                      ),
                    ),
